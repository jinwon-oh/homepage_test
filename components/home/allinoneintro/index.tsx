  ...
  return (
    <div className="w-full h-full mx-5">
      <div className="relative w-full h-full">
        ...
        <div className="absolute right-0 md:mr-5 xl:mr-24 w-full md:w-auto h-full flex flex-col justify-center items-center md:items-start text-center md:text-left bg-white bg-opacity-95">
          ...
          >
            <p className="text-center font-notoSansKR text-white text-[24px] font-bold">
              ...
              <span className={"inline-flex ml-[24px]"}>
                <img src="asset/img/rightArrow.png" className="h-[16px]" />
              </span>
            </p>
          </div>
        </div>
